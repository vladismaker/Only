...
public class ForHerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_for_her, container, false);
        ...
        try {
            ...
            JSONObject sectionData=jsonArraySection.getJSONObject(1);
        ...
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.recycler_view_her);
